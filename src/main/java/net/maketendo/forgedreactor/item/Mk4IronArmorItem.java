...
public abstract class Mk4IronArmorItem extends ArmorItem {
	public Mk4IronArmorItem(ArmorItem.Type type, Item.Properties properties) {
	...
	public static class Helmet extends Mk4IronArmorItem {
		public Helmet() {
		...
		public void appendHoverText(ItemStack itemstack, Level level, List<Component> list, TooltipFlag flag) {
			...
			list.add(Component.literal("\u00A78Mark IV (4)"));
		}

		@Override
		public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlot slot, String type) {
			return "forged_reactor:textures/entities/mk4_armor.png";
		}
	...
	public static class Chestplate extends Mk4IronArmorItem {
		public Chestplate() {
	...
	public static class Leggings extends Mk4IronArmorItem {
		public Leggings() {
	...
	public static class Boots extends Mk4IronArmorItem {
		public Boots() {
