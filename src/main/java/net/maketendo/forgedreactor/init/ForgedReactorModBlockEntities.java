...
public class ForgedReactorModBlockEntities {
	...
	public static final RegistryObject<BlockEntityType<?>> ARMOR_CONFIGURATOR = register("armor_configurator", ForgedReactorModBlocks.ARMOR_CONFIGURATOR, ArmorConfiguratorBlockEntity::new);
