	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition RightLeg = partdefinition.addOrReplaceChild("RightLeg",
				CubeListBuilder.create().texOffs(12, 3)
						.addBox(-1.0F, 13.0F, -1.0F, 0.0F, 7.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(12, 3)
						.addBox(1.0F, 13.0F, -1.0F, 0.0F, 7.0F, 2.0F, new CubeDeformation(0.0F)),
				PartPose.offset(-2.0F, 12.0F, 0.0F));

		PartDefinition cube_r1 = RightLeg.addOrReplaceChild("cube_r1",
				CubeListBuilder.create().texOffs(12, 3).mirror()
						.addBox(-1.0F, -1.0F, -1.0F, 0.0F, 7.0F, 2.0F, new CubeDeformation(0.0F)).mirror(false),
				PartPose.offsetAndRotation(0.0F, 14.0F, -2.0F, 0.0F, 1.5272F, 0.0F));

		PartDefinition cube_r2 = RightLeg
				.addOrReplaceChild("cube_r2",
						CubeListBuilder.create().texOffs(12, 3).addBox(-1.0F, -1.0F, -1.0F, 0.0F, 7.0F, 2.0F,
